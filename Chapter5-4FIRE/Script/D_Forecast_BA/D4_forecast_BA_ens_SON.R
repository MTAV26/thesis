...
dev.off()
# image.plot(lon, lat, mask_dataset)
image.plot(lon, lat, mask, add=T)
image.plot(lon, lat, best_roc_obs, col="purple", breaks = c(0,1))
