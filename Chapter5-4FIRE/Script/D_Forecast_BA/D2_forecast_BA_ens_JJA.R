...
for (idata in 1:length(datasets)) {
  ...
  load(paste0(dir_s5, "SPI3SEAS5_05_JUN_",dataset,".RData"))
  ...
  load(paste0(dir_s5, "SPI3SEAS5_05_MAY_",dataset,".RData"))
