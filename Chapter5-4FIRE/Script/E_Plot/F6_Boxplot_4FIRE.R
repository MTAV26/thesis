...
# dir_out= 'C:/Users/Usuario/4firebox/4FIRE/data/model_pred_FDR/'
dir_out= 'C:/Users/Usuario/Dropbox/4FIRE/Results/model_4fire_FDR_mean1/'
dir_out1= 'C:/Users/Usuario/Desktop/RESULTADOS-4FIRE/'
# dir_out1= 'C:/Users/Usuario/4firebox/4FIRE/Figuras/'
...
for (iseas in 1:length(seasons)) {
  ...
  postscript(
    file.path(
      dir_out1,
      paste("BOX_BS_pred_pval_",season,".eps", sep = "")
  ...
  my_boxplot(
    ...
    main=paste('Brier Score CLIBA (S5; ',season,')', sep=""),
    ylab='Brier Score', 
    cex.main = 1.5,
    cex.lab = 1.3,
...
for (iseas in 1:length(seasons)) {
  ...
  load(paste(dir_out,bs,'_',season,'_FDR_CPC_pval.RData', sep = ""))
  corre_box = as.vector(bs_pred_rel_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_GPCC_pval.RData', sep = ""))
  corre_box1 = as.vector(bs_pred_rel_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_PRECL_pval.RData', sep = ""))
  corre_box2 = as.vector(bs_pred_rel_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_ERA5_pval.RData', sep = ""))
  corre_box3 = as.vector(bs_pred_rel_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_JRA55_pval.RData', sep = ""))
  corre_box4 = as.vector(bs_pred_rel_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_NCEP_pval.RData', sep = ""))
  corre_box5 = as.vector(bs_pred_rel_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_MERRA2_pval.RData', sep = ""))
  corre_box6 = as.vector(bs_pred_rel_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_CAMS_OPI_pval.RData', sep = ""))
  corre_box7 = as.vector(bs_pred_rel_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_CHIRPS_pval.RData', sep = ""))
  corre_box8 = as.vector(bs_pred_rel_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_GPCP_pval.RData', sep = ""))
  corre_box9 = as.vector(bs_pred_rel_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_MSWEP_pval.RData', sep = ""))
  corre_box10 = as.vector(bs_pred_rel_pval)
  load(paste(dir_out,'bs_4fire_rel_',season,'_FDR_pval.RData', sep = ""))
  corre_box11 = as.vector(bs_4fire_rel_pval)
  ...
  postscript(
    file.path(
      dir_out1,
      paste("BOX_BS_REL_pred_pval_",season,".eps", sep = "")
      #paste("boxplot_corre_spi_", sc, "_ENS.eps", sep = "")
    ),
    horiz = FALSE,
    onefile = FALSE,
  ...
  my_boxplot(
    ...
    main=paste('Brier Score Reliability CLIBA (S5; ',season,')', sep=""),
    ylab='Reliability', 
    cex.main = 1.5,
    cex.lab = 1.3,
    col = c("white","white","white","white","white","white",
...
for (iseas in 1:length(seasons)) {
  ...
  load(paste(dir_out,bs,'_',season,'_FDR_CPC_pval.RData', sep = ""))
  corre_box = as.vector(bs_pred_res_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_GPCC_pval.RData', sep = ""))
  corre_box1 = as.vector(bs_pred_res_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_PRECL_pval.RData', sep = ""))
  corre_box2 = as.vector(bs_pred_res_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_ERA5_pval.RData', sep = ""))
  corre_box3 = as.vector(bs_pred_res_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_JRA55_pval.RData', sep = ""))
  corre_box4 = as.vector(bs_pred_res_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_NCEP_pval.RData', sep = ""))
  corre_box5 = as.vector(bs_pred_res_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_MERRA2_pval.RData', sep = ""))
  corre_box6 = as.vector(bs_pred_res_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_CAMS_OPI_pval.RData', sep = ""))
  corre_box7 = as.vector(bs_pred_res_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_CHIRPS_pval.RData', sep = ""))
  corre_box8 = as.vector(bs_pred_res_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_GPCP_pval.RData', sep = ""))
  corre_box9 = as.vector(bs_pred_res_pval)
  load(paste(dir_out,bs,'_',season,'_FDR_MSWEP_pval.RData', sep = ""))
  corre_box10 = as.vector(bs_pred_res_pval)
  load(paste(dir_out,'bs_4fire_res_',season,'_FDR_pval.RData', sep = ""))
  corre_box11 = as.vector(bs_4fire_res_pval)
  ...
  postscript(
    file.path(
      dir_out1,
      paste("BOX_BS_RES_pred_pval_",season,".eps", sep = "")
      #paste("boxplot_corre_spi_", sc, "_ENS.eps", sep = "")
    ),
    horiz = FALSE,
    onefile = FALSE,
  ...
  my_boxplot(
    ...
    main=paste('Brier Score Resolution CLIBA (S5; ',season,')', sep=""),
    ylab='Resolution', 
    cex.main = 1.5,
    cex.lab = 1.3,
    col = c("white","white","white","white","white","white",
...
for (iseas in 1:length(seasons)) {
  ...
  corre_box = as.vector(best_roc_pred)
  ...
  corre_box9 = as.vector(best_roc_pred)
  load(paste(dir_out,bs,'_',season,'_FDR_MSWEP.RData', sep = ""))
  corre_box10 = as.vector(best_roc_pred)
  load(paste(dir_out,'roc_4fire_',season,'_FDR.RData', sep = ""))
  corre_box11 = as.vector(roca_4fire)
  ...
  postscript(
    file.path(
      dir_out1,
      paste("BOX_ROC_pred_",season,".eps", sep = "")
      #paste("boxplot_corre_spi_", sc, "_ENS.eps", sep = "")
    ),
    horiz = FALSE,
    onefile = FALSE,
  ...
  my_boxplot(
    ...
    main=paste('ROC area CLIBA (S5; ',season,')', sep=""),
    ylab='ROC area', 
    cex.main = 1.5,
    cex.lab = 1.3,
    col = c("white","white","white","white","white","white",
