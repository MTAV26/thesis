...
if (where == 'mac') {
  ...
  dir_out_pre="C:/Users/Usuario/Dropbox/4FIRE/Results/model_4fire_FDR_mean1/"
  dir_out_obs="C:/Users/Usuario/Dropbox/4FIRE/Results/model_obs_FDR_mean1/"
  ...
  dir_out_pre="C:/Users/migue/Dropbox/4FIRE/Results/model_4fire_FDR_mean1/"
  dir_out_obs="C:/Users/migue/Dropbox/4FIRE/Results/model_obs_FDR_mean1/"
  ...
  dir_f51 = "/home/miguel/4FIRE/data/BA/"
  dir_drop ="/home/miguel/4FIRE/data/DROP/"
  # dir_data="/home/miguel/4FIRE/out/"
  dir_out_pre="/home/miguel/4FIRE/Results/model_4fire_FDR_mean1/"
  dir_out_obs="/home/miguel/4FIRE/Results/model_obs_FDR_mean1/"
  dir_s5 = '/home/miguel/4FIRE/data/forecast_s5/'
  dir_mask="/home/miguel/4FIRE/data/mask_season/"
  ...
  source('/home/miguel/4FIRE/script/model_BA/image_mask.R')
}
...
fname <- file.path(dir_drop, 'MSWEP_1981_2021.nc')
...
pdf(paste(dir_out_obs,"/ROC_DROP_JJA.pdf",sep = ""),width=11.5, height=12)
set.panel() 
...
for (idata in 1:length(datasets)) {
  ...
  if(dataset=="DROP"){
    load(paste0(dir_out_obs, "preBAobs_drop_JJA_FDR.RData"))
  ...
  if (dataset=="DROP"){
    load(paste0(dir_out_obs,"roc_",dataset,"_JJA_FDR.RData", sep="")) #best_roc_drop
    best_roc_obs=roca_drop
  } else {
    load(paste0(dir_out_obs,"roc_obs_JJA_FDR_",dataset,".RData", sep="")) #best_roc_drop
  }
...
mapPlot(coastlineWorld, col="white", projection="+proj=robin",breaks = brk_cor, drawBox = FALSE, 
        main = paste0('ROC area CLIBA-',dataset,' (',season,'): 
