...
for (idata in 1:length(datasets)) {
  ...
  if (dataset == "JRA55") {
    ...
    ### SAVE
    save(spi3, file = file.path(dir_out, paste0("SPI3_", dataset, "_1981_2020.RData")))
    save(spi6, file = file.path(dir_out, paste0("SPI6_", dataset, "_1981_2020.RData")))
    save(spi12, file = file.path(dir_out, paste0("SPI12_", dataset, "_1981_2020.RData")))
}
