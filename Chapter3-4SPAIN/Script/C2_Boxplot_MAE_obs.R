...
for (i in 1:12) {
  load(paste(dir_out, sprintf("MAE_OBS_spi6_%02d_CHIRPS.RData", i), sep = ""))
  corre_box[, (i * 3) - 2] = as.vector(corre)
  
  load(paste(dir_out, sprintf("MAE_OBS_spi6_%02d_EOBS.RData", i), sep = ""))
  corre_box[, (i * 3) - 1] = as.vector(corre)
  
  load(paste(dir_out, sprintf("MAE_OBS_spi6_%02d_ERA5.RData", i), sep = ""))
