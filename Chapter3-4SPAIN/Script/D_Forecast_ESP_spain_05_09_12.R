  ...
  for (idata in 1:length(datasets)) {
    ...
    for (ianni in 1:length(anni)) {
      ...
      for (ires in 1:length(anni_resampling)) {
        ...
        # djfmamjjason
        if (target_season == 'mayo' && start_date == 4) {
          PRE_FOR[, , mese_start + 3] = prec[, , mese_4]
          PRE_FOR[, , mese_start + 4] = prec[, , mese_5]
        } else if (target_season=='mayo' && start_date == 3){
          PRE_FOR[, , mese_start + 2] = prec[, , mese_3]
          PRE_FOR[, , mese_start + 3] = prec[, , mese_4]
          PRE_FOR[, , mese_start + 4] = prec[, , mese_5]
        } else if (target_season=='mayo' && start_date == 2){
        ...
        } else if (target_season == 'septiembre' && start_date == 8) {
          PRE_FOR[, , mese_start + 7] = prec[, , mese_8]
          PRE_FOR[, , mese_start + 8] = prec[, , mese_9]
        } else if (target_season=='septiembre' && start_date == 7){
          PRE_FOR[, , mese_start + 6] = prec[, , mese_7]
          PRE_FOR[, , mese_start + 7] = prec[, , mese_8]            
          PRE_FOR[, , mese_start + 8] = prec[, , mese_9]
        } else if (target_season=='septiembre' && start_date == 6){
        ...
        } else if (target_season == 'diciembre' && start_date == 11) {
          PRE_FOR[, , mese_start +10] = prec[, , mese_11]
          PRE_FOR[, , mese_start +11] = prec[, , mese_12]
        } else if (target_season=='diciembre' && start_date == 10){
          PRE_FOR[, , mese_start + 9] = prec[, , mese_10]
          PRE_FOR[, , mese_start +10] = prec[, , mese_11]            
          PRE_FOR[, , mese_start +11] = prec[, , mese_12]
        } else if (target_season=='diciembre' && start_date == 9){
          PRE_FOR[, , mese_start + 8] = prec[, , mese_9]
          PRE_FOR[, , mese_start + 9] = prec[, , mese_10]
          PRE_FOR[, , mese_start +10] = prec[, , mese_11]
          PRE_FOR[, , mese_start +11] = prec[, , mese_12]
        ...
        if (target_season == 'mayo') {
          spi6pred[, , mese_start + 4, ires] = spitmp[, , mese_start + 4]
        } else if (target_season == 'septiembre') {
          spi6pred[, , mese_start + 8, ires] = spitmp[, , mese_start + 8]
        } else if (target_season == 'diciembre') {
          spi6pred[, , mese_start + 11, ires] = spitmp[, , mese_start + 11]
        }
